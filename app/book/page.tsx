...
export default function BookingPage() {
  ...
  const handlePaystackPayment = () => {
    ...
    if (!service || !formData.name || !formData.phone || !selectedDate || !selectedTime) {
    ...
    const handler = (window as any).PaystackPop.setup({
      ...
      callback: (response: any) => {
        // Payment successful
        alert(`Payment successful! Reference: ${response.reference}. We'll contact you to confirm your appointment.`)
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Select a service, pick a date, and secure your spot with a 50% deposit. Each session takes approximately
              2-3 hours.
            </p>
          </div>
