...
async function testProfessionalEmailSystem() {
  ...
  try {
    ...
    const adminResult = await resend.emails.send({
      ...
      to: "bookings@lashedbydeedee.com", // Your professional Zoho email
      bcc: "lashedbydeedeee@gmail.com", // Hidden copy to your Gmail
    ...
    console.log("\n🎉 Professional email system test completed!")
    ...
    console.log("✅ Hidden copy sent to: lashedbydeedeee@gmail.com")
    console.log("✅ Your personal Gmail is never exposed to customers!")
  } catch (error) {
